...
import { formatDate, getBlockTitle, getPageProperty, normalizeTitle, parsePageId } from 'notion-utils'
  ...
  return (
    <>
      ...
      <NotionRenderer
        bodyClassName={cs(
          styles.notion,
          pageId === site.rootNotionPageId && 'index-page', tagsPage && 'tags-page'
        )}
        darkMode={isDarkMode}
